...
namespace Porject1
{
    class Program
    {
        static void Main(string[] args)//Static is a static variable and methods belong to the class instead of a specific instance
        {
            ...
            int op_x = 1;
            int op_d = 2;
            Console.WriteLine("Press any key to calculate op_y minus op_x {0}", op_y - op_x);
            Console.ReadKey();
            Console.WriteLine("Press any key to calculate op_y plus op_x{0}", op_y + op_x);
            Console.ReadKey();
            Console.WriteLine("Press any key to calculate op_y multiplied by op_x{0}", op_y + op_x);
            Console.ReadKey();
            Console.WriteLine("Press any key to calculate op_y divided by op_d{0}", op_y / op_d);
            Console.ReadKey();
